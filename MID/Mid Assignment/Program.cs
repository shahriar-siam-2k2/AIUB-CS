...
namespace MidCodeWriting_Course
{
    ...
    public class LiveCourse : Course
    {
        ...
        public LiveCourse(string courseId, string title, string instructorName, double basePrice, int maxStudents, int classWeek)
    ...
    public class RecordedCourse : Course
    {
        ...
        public RecordedCourse(string courseId, string title, string instructorName, double basePrice, int totalVideoHour, bool lifeTimeAccess)
            : base(courseId, title, instructorName, basePrice)
        {
        ...
        public int TotalVideoHour { set; get; }
        public int LifeTimeAccess { set; get; }
    ...
    public class Program
    {
        internal static void Main(string[] args)
        {
            ...
            courses[0] = new LiveCourse("CSE0123", "C#", "Simba", 6000, 40, 5);
            courses[1] = new RecordedCourse("POA0123", "Accounting", "Akash", 8000, 120, true);
